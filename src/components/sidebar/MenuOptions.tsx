...
const MenuOptions = ({
  ...
  const DefaultIcon = () => <div className="w-4 h-4 p-2 bg-gray-300 rounded"></div>;
              ...
              <CommandList className="py-4 overflow-visible">
                ...
                <CommandGroup className="overflow-visible">
                  {sidebarOpt.map((sidebarOptions) => {
                    ...
                    const Icon = result?.path || DefaultIcon; 
                    return (
                      <CommandItem
                        key={sidebarOptions.id}
                        className="md:w-[320px]  hover:!bg-blue-600/80 hover:shadow-2xl hover:shadow-blue-500  w-full"
                      >
                        <Link
