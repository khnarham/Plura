...
import { DeviceTypes, useEditor } from '../../../../../../../../provider/editor/EditorModel'
import { saveActivityLogsNotification, upsertFunnelPage } from '@/lib/quries'
...
const FunnelEditorNavigation = ({funnelId , funnelPageDetails , subaccountId}: Props) => {
   ...
   const handleOnBlurTitleChange: FocusEventHandler<HTMLInputElement> = async(event) =>{
       if(event.target.value === funnelPageDetails.id) return;
